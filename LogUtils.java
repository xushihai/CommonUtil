package com.example.administrator.vpndemo.common;
...
public class LogUtils {
    ...
    public static final int NOTHING = 6;//不打印任何日志,产品发布的时候手动更改LEVEL为NOTHING
    public static int LEVEL = VERBOSE;
    public static final String SEPARATOR = ",";

    public static void v(String message) {
        if (LEVEL <= VERBOSE) {//小于等于
     ...
     * 设置是否为开发模式
     */
    public static void developerModeEnable(boolean enable){
